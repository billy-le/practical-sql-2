...
SELECT
    make_timestamptz(2022, 2, 22, 18, 4, 30.3, 'Europe/Lisbon');
...
-- Math with dates!
SELECT
    '1929-09-30'::date - '1929-09-27'::date;

SELECT
    '1929-09-30'::date + '5 years'::INTERVAL;
...
-- Set this if your PostgreSQL server defaults to a time zone other than US/Eastern
SELECT
...
COPY (
    ...
    ORDER BY
        trip_hour
) TO 'C:\YourDirectory\hourly_taxi_pickups.csv' WITH (FORMAT CSV, HEADER);
...
VALUES
    (
        'Chicago to New York',
        '2020-11-13 21:30 CST',
        '2020-11-14 18:23 EST'
    ),
    (
        'New York to New Orleans',
        '2020-11-15 14:15 EST',
        '2020-11-16 19:32 CST'
    ),
    (
        'New Orleans to Los Angeles',
        '2020-11-17 13:45 CST',
        '2020-11-18 9:00 PST'
    ),
    (
        'Los Angeles to San Francisco',
        '2020-11-19 10:10 PST',
...
SELECT
    (
        '2100-01-01 00:00:00 EST' AT TIME ZONE 'Europe/London'
    ) AS London,
    (
        '2100-01-01 00:00:00 EST' AT TIME ZONE 'Africa/Johannesburg'
    ) AS Johannesburg,
    (
        '2100-01-01 00:00:00 EST' AT TIME ZONE 'Europe/Moscow'
    ) AS Moscow,
    (
        '2100-01-01 00:00:00 EST' AT TIME ZONE 'Australia/Melbourne'
    ) AS Melbourne;
